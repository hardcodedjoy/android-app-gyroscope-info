package com.hardcodedjoy.example.gyroscopeinfo;
...
public class MainActivity extends Activity {
    ...
    private void onSensorData(float x, float y, float z) {
        ...
        String s = "";
        s += "gyro_x = " + String.format(Locale.US, "%.4f", x) + " rad/s\n";
        s += "gyro_y = " + String.format(Locale.US, "%.4f", y) + " rad/s\n";
        s += "gyro_z = " + String.format(Locale.US, "%.4f", z) + " rad/s";
